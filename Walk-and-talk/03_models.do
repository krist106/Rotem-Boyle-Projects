...
coefplot (muslim) (christian) (other), keep(walk_notalk:) bylabel("Walking but not talking") || ///
 ...
 drop(_cons *country *urban *wealthq *pipedwtr *agefrstmar_c *educlvl *edugap) eform scheme(cleanplots) byopts(rows(1)) msize(large) ysize(40) xsize(70) xline(1) sub(,size(medium)) xtitle(Relative Risk Ratio) plotlabels("Muslim" "Christian" "Other")
